class ActionType::ForgerVote < ActionType
  ...
  def before_creation
    ...
    self.action_result_type_id = ActionResultType::FORGER_VOTE
  end
  ...
  def create_valid_action_results(actions, city)
    ...
    action_array_per_resident.each_pair { |resident, actions|
      ...
      logger.info('MANUAL LOG - valid forger vote actions: ' + vote_counts.to_json())
