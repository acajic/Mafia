class ActionType::Investigate < ActionType
  ...
  def before_creation
    ...
    self.action_result_type_id = ActionResultType::INVESTIGATE
  end
  ...
  def create_valid_action_results(actions, city)
    ...
    actions_per_resident.each_pair { |resident, action|
      ...
      action_results << {:action => action,
                         ...
                         :result => {self.action_result_type.class::KEY_TARGET_ID => target_id, self.action_result_type.class::KEY_SUCCESS => target_resident.role.affiliation_id == Affiliation::MAFIA},
  ...
  def create_void_action_results(actions, city)
    ...
    actions_per_resident.each_pair { |resident, action|
      ...
      sample_resident = city.residents.select{ |r| r.alive }.sample
