class ActionType::SheriffIdentities < ActionType
  ...
  def before_creation
    ...
    self.name = 'Reveal Identities'
    self.action_result_type_id = ActionResultType::SHERIFF_IDENTITIES
  end
  ...
  def create_valid_action_results(actions, city)
    ...
    actions_per_resident.each_pair { |resident, action|
      ...
      action_results << {:action => action,
                         ...
                         :resident_id => result_hash[self.action_result_type.class::KEY_SUCCESS] ? nil : resident.id,
  ...
  def create_void_action_results(actions, city)
    ...
    actions_per_resident.each_pair { |resident, action|
      result_hash = {self.action_result_type.class::KEY_DEAD_RESIDENTS_ROLES => [],
                     self.action_result_type.class::KEY_SUCCESS => false}
